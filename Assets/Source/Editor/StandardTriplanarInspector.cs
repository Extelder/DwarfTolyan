...
public class StandardTriplanarInspector : ShaderGUI
{
    static class Styles
    {
        ...
        static public readonly GUIContent emission = new GUIContent("Emission", "Emission (RGB)");
    ...
    public override void OnGUI(MaterialEditor editor, MaterialProperty[] props)
    {
        ...
        editor.TexturePropertySingleLine(
            Styles.emission, FindProperty("_EmissionTex", props), FindProperty("_EmissionColor", props)
        );
        ...
        editor.ShaderProperty(FindProperty("_EmissionMapScale", props), "Emission Texture Scale");
